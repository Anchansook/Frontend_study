...
const nameAndUnkownHeight: {
  name: string;
  height?: number; // 타입 명시 속성 뒤에 물음표를 작성 > 선택적 프로퍼티
} = {
  name: '이용주',
  // height: 190 - 작성 해도 안 해도 오류 안 남!
};

//! 읽기 전용 속성
// : 속성명 앞에 readonly 키워드를 사용하여 해당 속성의 재할당을 금지
// : 해당 키워드가 붙은 속성은 const키워드를 이용한 변수 정의와 유사
...
readonlyName.age = 28;
console.log(readonlyName.age); // 28

// readonlyName.name = '정재형'; - Error: 읽기 전용 속성이므로 'name'에 할당할 수 없습니다.
console.log(readonlyName.name); // 이용주
