...
class Employee {
  ...
  private salary: number; // 급여 - 해당 클래스 내부에서만 접근 가능
  protected department: string; // 부서 - 해당 클래스 | 하위 클래스에서만 접근 가능
  ...
  // 메서드 정의
  // 직원의 정보를 출력하는 메서드 - public (어디서든 접근 가능)
  public displayInfo() {
...
let employee1 = new Employee('이용주', 50000, 'IT');
console.log(employee1.name); // 이용주
...
//? 생성자의 경우 멤버 선언 외에도 생성자의 매개변수 앞에 접근제한자 명시 가능
