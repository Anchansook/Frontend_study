...
// 추상화: 복잡한 세부사항은 정의하지 않음!, 필수적인 부분만을 강조하는 것
...
// : 데이터(속성)
// - 위 데이터(속성)를 처리하는 기능(게시글 생성, 수정 등)
// : 기능(메서드, 행동)
...
// : . 연산자를 사용하여 접근
console.log(myBook1.title); // undifined
...
// : 해당 멤버 변수를 초기화 하지 않은 경우 undifined로 인식
