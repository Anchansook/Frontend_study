...
// 2. completeTodo: Todo항목의 completed상태를 true로 변경
...
function addTodo (todos: ITodoItem[], task: string): ITodoItem[] {
  const newTodo: ITodoItem = {
    ...
    task: task,
    completed: false, // 새로운 Todo항목은 기본적으로 미완료 상태
  };
  // 기존 Todo 리스트에 새로운 Todo항목을 추가
...
function deleteTodo (todos: ITodoItem[], id: number): ITodoItem[] {
  // 요소 개수의 차이가 있다. => filter

  // 해당 id를 가진 Todo항목을 제외한
...
[
  ...
  { id: 2, task: '자바스크립트 복습하기', completed: false },
  { id: 3, task: 'HTML / CSS 복습하기', completed: false }
]
*/
...
[
  ...
  { id: 2, task: '자바스크립트 복습하기', completed: true },
  { id: 3, task: 'HTML / CSS 복습하기', completed: false }
]
*/
