...
console.log(arrowGreet('이용주')); // Hello 이용주
...
// 'lyj'가 name으로, 'hello'가 greeting으로 설정
console.log(select('lyj', 'hello')); // hello lyj
...
console.log(greetEveryone('이용주', 30, '김민수', '정재형', '안찬숙'));
// Hello 김민수, Hello 정재형, Hello 안찬숙
...
function add(a: any, b: any): any {
  // 함수의 구현부: 단일 함수명에 대한 중괄호는 반드시 하나!
