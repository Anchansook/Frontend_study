//! JS 조건문 예제 (!! 직접 다시 풀어보기 !!)

let score; // 점수를 저장할 변수 선언

//? 해당 결과가 출력되도록 임의의 값을 할당

// 1. 점수가 70점 이상인 경우 '합격!'을 출력(콘솔창에)
...
// 3.
//- 점수가 0점 미만,(이거나 ||의 의미!!) 100점 초과인 경우 '점수가 잘못되었습니다.' 출력
// - 90점 이상 'A' 출력
// - 80점 이상 'B' 출력
// - 70점 이상 'C' 출력
// - 그 외에는 'D' 출력
...
if (score < 0 || score > 100) {
  ...
  console.log('A');
} else if (score >= 80) { // 80이상 89이하의 수
  console.log('B');
} else if (score >= 70) { // 70이상 79이하의 수
  console.log('C');
} else {
  console.log('D'); // 0이상 70미만의 수
};
...
// : a && b에서 a가 false인 경우 b는 평가하지 않음!
true && console.log('A');
false && console.log('A'); 

// - 회원 정보의 유무에 따른 페이지 접근 제한

let token = ''; // 회원정보 없음 - 비어있음 - false
