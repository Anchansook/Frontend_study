...
*/
// >> 조건
// : 보통 비교 연산자를 사용해 표현(동등, 일치, 부등호 - boolean타입으로 반환)
...
if (조건1) {
  ...
  조건 1과 2가 거짓이고, 조건3이 참일 때 실행되는 코드
  ...
} else {
...
// boolean타입에서 false값으로 인식되는 값
// >> (false, 0, '', null, undefined)
// : 위의 값을 제외하고는 true의 값을 반환하기 때문에 변수가 참인지 또는 그 값이 존재하는지를 테스트 하기 위해서,  변수 이름 그 자체를 사용할 수 있음

// 조건식에서 변수명을 boolean타입과 일치여부 확인을 하지 않아도 된다.
...
//* 기본 구조
// 조건 ? 표현식1 : 표현식2
// : 주어진 조건을 평가한 후 그 결과가 true면 표현식1을 false면 표현식2를 실행
