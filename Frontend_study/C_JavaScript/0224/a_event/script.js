...
// - btn.onfocus: 버튼이 포커스되었을 때 실행 (tab 사용 시 포커스)
...
// : 여러개의 요소의 참조를 모두 가져와 한 번에 이벤트 핸들러를 추가
// : 해당 참조값들이 배열(리스트)로 저장
const buttons = document.querySelectorAll('button');

// for (let i = 0; i < buttons.length; i++) {
//   각각의 요소에 접근할 때마다 해당 요소에 onclick의 속성으로 bgChange 함수를 전달
//   buttons[i].onclick = bgChange;
// };

// forEach를 사용하여 위의 반복문을 재작성 (더욱 간단하게!)
// : 콜백함수(함수의 인자로 함수가 전달)
...
// addEventListener 메서드는 요소에 이벤트리스너를 '추가'
// : 두 가지 매개변수
