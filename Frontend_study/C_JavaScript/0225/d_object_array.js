//! 객체의 속성 존재 여부 확인
// : 객체에 없는 속성에 접근 - undefined 자료형 반환
...
if (Object.name !== undefined) { // 부정에 부정으로써 긍정!
  // name 속성이 존재
...
const product0228 = ['양파', ...addProduct, ...product0225]; // 배열 전달이 아니라 배열의 요소값만 전달하는 방법
