document.addEventListener('DOMContentLoaded', () => {
  ...
  // : HTML문서 구조를 인식하여 해석한 뒤 내용만 삽입

  //? JS에서 글자 조작 시에는 문서 구조는 HTML이 담당하기 때문에 문서구조를 직접 생성하는 innerHTML보다 기능적인 텍스트만 첨부하는 textContent를 사용하는 것을 권장
