...
// 인덱스의 시작 값은 0
// : 배열의 각각의 데이터를 - '요소'
// : 크기가 고정되어 있지 않고, 프로그램 실행 중 동적으로 사용 가능
...
//? 배열의 이름은 여러 개의 데이터를 담는 특성을 살려 '복수형태'로 작성을 권장
...
//! 배열의 길이와 동적 성질
// : 배열명.length 속성을 사용하여 배열읙 길이를 확인
...
//? includes()
// : 배열에 특정 요소가 존재하는지 확인만
// : 그 결과를 불리언 값으로 반환(요소의 인덱스 요소로 반환하는게 아니라, 존재 유무만 확인)
