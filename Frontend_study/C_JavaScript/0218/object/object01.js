...
let person1 = new Human('안찬숙', 18);
let person2 = new Human('피식대학', 28);
...
let dog = {
  ...
  } // 여기 뒤엔 세미콜론 안 붙임! 붙이니 ERROR!
};

// 프로퍼티(속성) 추가
dog.speed = 10;
console.log(dog); // { name: '초코', age: 3, color: 'white', speed: 10 }
...
// human1과 human2는 서로 다른 객체이기 때문에 각각의 이름으로 생성됨
// : this가 가리키는 객체가 다름 (실행중인 코드가 속한 객체)

human1.greeting(); // 안찬숙
human2.greeting(); // 피식대학